...
## 项目亮点
- 经过压测验证，结合prometheus监控，在戴尔g15 3060 windows硬件环境下可以稳定承载10000+ 级websocket长连接
- 针对 2000 人超大群场景完成极限脉冲压测：1000 名用户同时并发发送群消息，每条消息自动过滤发送者本人，理论产生1999000 次 WebSocket 底层推送 IO；服务端仅耗时 70 秒完整完成全量广播，折算单机峰值吞吐约 2.86 万次 WebSocket 推送 / 秒，并且无消息丢失，推送失败率为0
...
## 针对2000人大群(数据来源于prometheus监控)
压测批次	总推送 IO	耗时	每秒推送吞吐
300 条消息	599700	42s	14279 次 / 秒
500 条消息	999500	42s	23798 次 / 秒
1000 条消息	1999000	70s	28557 次 / 秒
